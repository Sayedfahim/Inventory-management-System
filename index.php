...
<html>
<head>
	<title>SMS Homepage - Stock Management System</title>
...
<body>
   ...
   <div class="homepageContainer">
   	<div class="homepageFeatures">
   	 <div class="homepageFeature">
   	 	...
   	 	<p class="featureDescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit.suspendisse fringills fringills. </p>
   	 </div>
   ...
   <div class="homepageNotified">
   	<div class ="homepageContainer">
     	...
     	<p>Simple service for monitoring websites for changes. You'll receive an email notification when it detects any change in the content of the page.</p>
     	<form action="">
   ...
   <div class="socials">
   	<div class="homepageContainer">
   		...
   		<p class="socialText">Lorem ipsum dolor sit amet, consectetur adipiscing elit.suspendisse fringills fringills.</p>
